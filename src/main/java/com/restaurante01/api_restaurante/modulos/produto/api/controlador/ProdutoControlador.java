...
public class ProdutoControlador {
    ...
    public ProdutoControlador(CriarProdutoCasoDeUso criarProdutoCasoDeUso,
    ...
    public ResponseEntity<ApiResponse<ProdutoDTO>> adicionarProduto(@Valid @RequestBody CriarProdutoDTO produtoDTO){
    ...
    public ResponseEntity<ApiResponse<LoteProdutosRespostaDTO>> atualizarProdutos(@Valid @RequestBody List<ProdutoDTO> produtos){
        List<ProdutoDTO> produtoAtualizado = atualizarProdutosEmLoteCasoDeUso.executar(produtos);
        LoteProdutosRespostaDTO resposta = new LoteProdutosRespostaDTO
