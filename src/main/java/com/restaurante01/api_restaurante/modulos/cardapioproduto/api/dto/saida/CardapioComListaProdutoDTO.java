package com.restaurante01.api_restaurante.modulos.cardapioproduto.api.dto.saida;
...
public class CardapioComListaProdutoDTO {
    private Long id;
    private String nome;
    ...
    public CardapioComListaProdutoDTO(){};
    public CardapioComListaProdutoDTO(Long id, String nome, String descricao, Boolean disponibilidade,
