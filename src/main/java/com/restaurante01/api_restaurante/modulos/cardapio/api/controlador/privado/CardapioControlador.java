...
public class CardapioControlador {
    ...
    public CardapioControlador(CriarCardapioCasoDeUso criarCardapioCasoDeUso,
    ...
    @PostMapping("/criar")
    public ResponseEntity<ApiResponse<CardapioDTO>> adicionarNovoCardapio(@Valid @RequestBody CriarCardapioDTO cardapioDTO){
