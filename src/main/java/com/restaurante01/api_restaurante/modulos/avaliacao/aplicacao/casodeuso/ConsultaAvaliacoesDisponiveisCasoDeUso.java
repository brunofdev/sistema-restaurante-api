...
@Service
@AllArgsConstructor
public class ConsultaAvaliacoesDisponiveisCasoDeUso {
    private final AvaliacaoRepositorio repositorio;
    private final AvaliacaoMapeador mapeador;

    public List<AvaliacaoDTO> executar (){
        List<Avaliacao> avaliacoesDisponiveis = repositorio.buscarTodasPorStatus(StatusAvaliacao.DISPONIVEL);
        return mapeador.mapearListaAvaliacoesDTO(avaliacoesDisponiveis);
    }
}
