...
@Service
@AllArgsConstructor
public class ConsultaAvaliacoesConcluidasCasoDeUso {
    private final AvaliacaoRepositorio repositorio;
    private final AvaliacaoMapeador mapeador;

    public List<AvaliacaoDTO> executar(){
        List<Avaliacao> avaliacaosConcluidas = repositorio.buscarTodasPorStatus(StatusAvaliacao.CONCLUIDA);
        return mapeador.mapearListaAvaliacoesDTO(avaliacaosConcluidas);
    }
}
