package com.restaurante01.api_restaurante.modulos.usuario.cliente.api.dto.entrada;
...
public record CadastrarClienteDTO(
        ...
        @Schema(description = "Referencia para endereço (opcional)", example = "Casa branco portao cinza")
        @Size(max = 100, message = "O complemento deve ter no máximo 100 caracteres.")
        String referencia
) {

    public CadastrarClienteDTO withSenha(String senhaCriptografada) {
